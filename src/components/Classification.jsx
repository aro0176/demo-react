...
function Classification() {
    ...
    const newData = async () => {
        ...
        if(numero == ''){
            ...
            const response = await axios.post('https://api.apmf.com/new', {'numero': numero, 'nom_class': nomClass})
    ...
    const deleteClass = (e) => {
        ...
        if(confirm_delete){
            ...
            axios.delete(`https://api.apmf.com/delete/${select_data}`)
                    .then((resp) => {
                        console.log(resp);
                    })
                    .catch((err) => {
    ...
    const updateClass = (e) => {
        console.log(e.target.getAttribute('id_data'));
        setIsNew(false)
        axios.get(`https://api.apmf.com/one/${e.target.getAttribute('id_data')}`)
                .then(resp => {
                    console.log(resp);
    ...
    const updateData = () => {
        axios.put(`https://api.apmf.com/update/${selectData}`, {'nom_class': nomClass, 'numero': numero})
            .then(resp => {
                console.log(resp);
            })
            .catch(err => {
    ...
    useEffect(() => {
        axios.get('https://api.apmf.com/all')
                .then((resp) => {
